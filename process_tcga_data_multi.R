...
#View(exp_assay)
#dim(exp_assay)
exp_assay_frame<-as.data.frame(exp_assay)
...
saveRDS(exp_assay_frame,paste0("./data/tcga_data/",cancer_type,"_exp_assay_frame.RData"))
#View(exp_assay_frame)
#colnames(exp_assay)
#rownames(exp_assay)
#dim(exp_assay)
...
saveRDS(exp_intgr, paste0("./data/tcga_data_processed/",cancer_type,"_exp_intgr_all.RData"))
write.csv(exp_intgr,paste0("./data/tcga_data_processed/",cancer_type,"_exp_intgr_all.csv"))
